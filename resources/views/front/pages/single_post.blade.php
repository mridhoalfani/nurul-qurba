        ...
        <div class="col-lg-8 mb-5 mb-lg-0">
            ...
            @if (count($related_posts) > 0)
                <div class="widget-list mt-5">
                    <h2 class="mb-4">Postingan terkait</h2>
            ...
            <div class="mt-5">
                ...
                <script>
                    ...
                    (function() { // DON'T EDIT BELOW THIS LINE
                        ...
                        s.src = 'https://larablog-site-11.disqus.com/embed.js';
...
@push('stylesheets')
    ...
    <script type="text/javascript"
        src="https://platform-api.sharethis.com/js/sharethis.js#property=65b151002bb34700194aa3ab&product=sticky-share-buttons&source=platform"
        async="async"></script>
@endpush
@push('scripts')
