...
<head>
    ...
    <!-- # CSS Plugins -->
    <link rel="stylesheet" href="/front/1/plugins/bootstrap/bootstrap.min.css">
    @stack('stylesheets')

    <!-- # Main Style Sheet -->
    <link rel="stylesheet" href="/front/1/css/style.css">
...
<body>
    ...
    <!-- # JS Plugins -->
    <script src="/front/1/plugins/jquery/jquery.min.js"></script>
    <script src="/front/1/plugins/bootstrap/bootstrap.min.js"></script>
    @stack('scripts')
    <!-- Main Script -->
    <script src="/front/1/js/script.js"></script>
