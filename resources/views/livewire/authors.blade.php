                    ...
                    <form wire:submit.prevent='addAuthor()' method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="example-text-input"
                                placeholder="Input name" wire:model='name' />
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" name="example-text-input"
                                placeholder="Input email" wire:model='email' />
                            <span class="text-danger">
                                @error('email')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="example-text-input"
                                placeholder="Input username" wire:model='username' />
                            <span class="text-danger">
                                @error('username')
                                    {{ $message }}
                                @enderror
                            ...
                            <div>
                                <label class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="radios-inline"
                                        name="direct_publish" value="0" wire:model='direct_publish'>
                                    <span class="form-check-label">No</span>
                                </label>
                                <label class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="radios-inline"
                                        name="direct_publish" value="1" wire:model='direct_publish'>
                                    <span class="form-check-label">Yes</span>
                                </label>
                            </div>
                            <span class="text-danger">
                                @error('direct_publish')
                                    {{ $message }}
                                @enderror
                            </span>
                        </div>
