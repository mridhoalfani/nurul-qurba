    ...
    <div class="page-header d-print-none mb-2">
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="d-flex">
                    <input type="search" class="form-control d-inline-block w-9 me-3" placeholder="Search author…" wire:model.live='search'>
            ...
            <div class="modal-body">
                <form wire:submit.prevent='addAuthor()' method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" name="example-text-input" placeholder="Input email" wire:model='email'/>
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            ...
                            <input class="form-check-input" type="radio" name="radios-inline" name="direct_publish" value="0" wire:model='direct_publish'>
                            <span class="form-check-label">No</span>
                            </label>
                            <label class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="radios-inline" name="direct_publish" value="1" wire:model='direct_publish'>
