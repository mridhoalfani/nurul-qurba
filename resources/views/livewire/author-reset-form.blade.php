<div>
    ...
    <form  method="post" autocomplete="off" novalidate wire:submit.prevent='ResetHendler()'>
        <div class="mb-3">
        ...
        <div class="mb-2">
            ...
            <div class="input-group input-group-flat">
                <input type="password" class="form-control"  placeholder="Your new password" autocomplete="off" wire:model='new_password'>
