<div>
    ...
    {{-- MODALS --}}
    <div wire:ignore.self class="modal modal-blur fade" id="categories_modal" tabindex="-1" data-bs-backdrop="static"
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="example-text-input"
                            placeholder="Input category name" wire:model='category_name'>
    ...
    <div wire:ignore.self class="modal modal-blur fade" id="subcategories_modal" tabindex="-1"
            ...
            @else
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="example-text-input"
                            placeholder="Input sub category name" wire:model='subcategory_name'>
                        <span class="text-danger">
