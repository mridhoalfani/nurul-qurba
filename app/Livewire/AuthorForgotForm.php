...
class AuthorForgotForm extends Component
{
    ...
    public function ForgotHendler(){
        ...
        $body_message = "we are received a request to reset  the password for <b>Larablog</b> account assosiated with".
        $this->email.". <br> You can reset the password by clicking the button below.";
        $body_message.='<br>';
